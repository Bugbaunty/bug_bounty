  ...
  return (
    <GlareCard className="flex flex-col p-8">
      ...
      <div className="flex flex-col mt-4">
        <p className=" text-[1rem] bg-gradient-to-r  from-linear-1 to-linear-2 bg-clip-text text-[transparent]">
          Price
        </p>
        <p className="mt-2 bg-gradient-to-r text-[1.3rem]  from-linear-1 to-linear-2 bg-clip-text text-[transparent]">
          $5000{" "}
        </p>
      </div>
    </GlareCard>
