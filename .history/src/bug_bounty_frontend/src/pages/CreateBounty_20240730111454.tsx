      ...
      <div className="mt-[5rem] flex flex-col w-full mb-4 mx-4 lg:mx-8">
        ...
        <div className="flex justify-end w-full items-center">
          <div className=" flex justify-between items-center mt-4">
            <p className="text-color-7 hover:text-[#EA4343]  py-2 px-[.9rem] text-[0.85rem] border border-solid border-[#EA4343]/20 sm:text-sm cursor-pointer hover:bg-[#211416]">
              Cancel
            </p>
            <p className="ml-8 text-color-7 hover:text-[#3DB569]  py-2 px-[.9rem] text-[0.85rem] border border-solid border-[#3DB569]/20 sm:text-sm cursor-pointer hover:bg-[#111E18]">
              Submit
            </p>
          </div>
        </div>
